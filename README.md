...
```
  ...
  mkdir "09.اول سموئیل"
  mkdir "10.دوم سموئیل"
  mkdir "11.اول پادشاهان"
  mkdir "12.دوم پادشاهان"
  mkdir "13.اول تواریخ"
  mkdir "14.دوم تواریخ"
  mkdir "15.عزرا"
  mkdir "16.نحمیا"
  ...
  mkdir "44.اعمال"
  mkdir "45.رومیان"
  mkdir "46.اول قرنتیان"
  mkdir "47.دوم قرنتیان"
  mkdir "48.غلاطیان"
  mkdir "49.افسسیان"
  mkdir "50.فیلیپیان"
  mkdir "51.کولسیان"
  mkdir "52.اول تسالونیکیان"
  mkdir "53.دوم تسالونیکیان"
  mkdir "54.اول تیموتائوس"
  mkdir "55.دوم تیموتائوس"
  mkdir "56.تیطس"
  mkdir "57.فلیمون"
  mkdir "58.عبرانیان"
  mkdir "59.یعقوب"
